...
//   private swordName: string = 'sword';
...
//   constructor(scene: GameScene, owner: Player, effectLayer: Phaser.GameObjects.Container, index: number, name: string) {
...
//     this.offset = this.getRange();  // 초기 offset을 플레이어의 range로 설정
//     this.index = index;
...
//     this.scene.createAnimation('effects', `${this.swordName}_attack`, [0, 4], 1000 / Math.max(100, this.owner.jumpCoolDown) * 6, 0);
//   }
...
//     const scaleMultiplier = (this.owner.body!.height + this.getRange()) / 40;
...
//     this.attackEffect.play(this.swordName + '_attack');
...
//     if (this.owner.hasItem("death_sword")) {
//       this.setFrame(`death_sword-${angleIndex}`);
//     } else {
...
//     this.offset = this.owner.body!.height + this.getRange();
...
//   getRange(): number {
//     this._range = this.owner.stats.range;
